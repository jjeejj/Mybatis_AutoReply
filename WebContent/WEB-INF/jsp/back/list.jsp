...
<body style="background: #e1e9eb;">
		<form action="<%=basePath %>list.action" id="mainForm" method="post">
			<div class="right">
				...
				<div class="rightCont">
					<p class="g_title fix">内容列表 <a class="btn03" href="#">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03" href="javaccript:deleteBatch('<%=basePath %>')">删 除</a></p>
					<table class="tab1">
						<tbody>
							<tr>
							...
							<tbody>
								...
								<c:forEach items="${messageList}" var="message" varStatus="status">
									<tr <c:if test="${status.index%2==1}">style="background-color:#ECF6EE;"</c:if>>
										...
										<td>${status.index + 1}</td> <!--status 从0开始计数的 -->
	...
	<script src="<%=basePath %>static/js/jquery-1.8.0.min.js"></script>
